...
public class RokakakaTreeBlock extends JojosblockyadventureModElements.ModElement {
	@ObjectHolder("jojosblockyadventure:rokakaka_tree")
	public static final Block block = null;
	public RokakakaTreeBlock(JojosblockyadventureModElements instance) {
		super(instance, 11);
